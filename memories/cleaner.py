...
def comicsify(blob):
    ...
    def country(comic):
        name = comic.pop(u'ico')
        comic.update({u'country': {u'Autre.png': None,
                                   u'France.png': [u'fr'],
                                   u'Germany.png': [u'de'],
                                   u'Italy.png': [u'it'],
                                   u'Japan.png': [u'jp'],
                                   u'Netherlands.png': [u'nl'],
                                   u'Portugal.png': [u'pt'],
                                   u'Spain.png': [u'es'],
                                   u'USA.png': [u'us']}.get(name)})
    ...
    def title(comic):
        ...
        s = '' if ((series != title and title.lower().startswith(series.lower())) or series.startswith('(AUT)'))
            else series
    ...
    return title(year(country(blob)))
